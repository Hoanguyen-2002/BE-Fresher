...
public interface ReviewRepository extends JpaRepository<Review, String> {
    ...
    @Query("SELECT r FROM Review r WHERE r.reviewId = :reviewId AND r.account.accountId = :accountId")
    Optional<Review> findByReviewIdAndAccountId(@Param("reviewId") String reviewId, @Param("accountId") String accountId);

    @Modifying
    @Query("UPDATE Review r SET r.isDeleted = true WHERE r.reviewId = :reviewId")
    void softDeleteByReviewId(@Param("reviewId") String reviewId);
}